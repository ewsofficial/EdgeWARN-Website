...
export default function LeafletMap() {
    ...
    return (
        <div className="flex bg-gray-900 text-gray-100 h-screen font-sans overflow-hidden">
             ...
             {/* Combined Left Panel Group - Responsive - REVERTED TO DESKTOP */}
             <div className="flex flex-col flex-shrink-0 z-30 shadow-xl bg-gray-800
                             relative w-[23.5rem] h-full max-h-full">
                 ...
                 <div className="flex min-h-0 overflow-hidden
                     ...
                     <div className="flex-shrink-0 flex bg-gray-950 z-20
                                     w-14 h-full flex-col border-r justify-start">
                         {/* Logo Container */}
                         <div className="flex-shrink-0 h-14 items-center justify-center border-b border-gray-800 flex">
                         ...
                         {/* Rail Content */}
                         <div className="flex-1 flex items-center gap-4 px-0 justify-start
                                         flex-col py-4">
                            <button
                     ...
                     <div className={`flex-shrink-0 flex flex-col bg-gray-800 overflow-y-auto border-gray-700
                                      w-80 h-auto border-r border-b-0 flex-1`}>
