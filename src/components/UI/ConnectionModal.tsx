...
export default function ConnectionModal({
    ...
    return (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative w-full max-w-[500px] m-4 perspective-1000 group/modal animate-in slide-in-from-bottom-full fade-in duration-500 ease-out fill-mode-forwards">
